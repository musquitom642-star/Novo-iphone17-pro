            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-2 gap-8 mb-16">
                    <div className="bg-gray-900 rounded-3xl p-8">
                        ...
                        <p className="text-gray-300">Estrutura em titânium de grau aeroespacial. O smartphone mais forte e leve.</p>
                    </div>
                ...
                <div className="bg-gray-900 rounded-3xl p-12 mb-16" id="performance">
                    ...
                    <p className="text-gray-300">O chip mais poderoso de um smartphone</p>
